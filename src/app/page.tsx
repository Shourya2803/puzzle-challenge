...
export default function Home() {
  return (
    <div className="container mx-auto px-4 py-12 bg-[#FFFFF0]">
      {/* Hero Section */}
      <section className="text-center mb-16">
        <h1 className="text-5xl md:text-6xl font-['Playfair_Display'] font-bold text-gray-900 mb-6">
          PuzzleChallenge
        </h1>
        <p className="text-xl font-['Lora'] text-gray-600 mb-8 max-w-2xl mx-auto">
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-['Playfair_Display'] font-semibold text-center mb-12 text-gray-900">
          How It Works
        </h2>
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="text-center p-6 rounded-2xl shadow-md border border-gray-200 hover:border-[#FFD700] transition">
            <div className="w-16 h-16 bg-[#008080]/10 rounded-full flex items-center justify-center mx-auto mb-4">
              <span className="text-2xl">🧩</span>
            </div>
            <h3 className="text-xl font-['Playfair_Display'] font-semibold mb-3 text-gray-900">
              Daily Puzzles
            </h3>
      ...
      <section className="max-w-2xl mx-auto">
        <h2 className="text-3xl font-['Playfair_Display'] font-semibold text-center mb-8 text-gray-900">
          Get in Touch
        </h2>
        <ContactForm />
      </section>
